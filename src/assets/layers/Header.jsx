...
const Header = () => {
  ...
  return (
    <section className="max-w-[1440px] mx-auto w-full">
      <div className="mira-header-before flex flex-col lg:flex-row fixed w-[calc(min(100%,1440px)-30px)] lg:w-[calc(min(100%,1440px)-120px)] bg-white z-20 left-[calc(50%-min(660px,calc((100%/2)-15px)))] lg:left-[calc(50%-min(660px,calc((100%/2)-60px)))] top-0 justify-between items-center py-3 border-b-2 border-[#CFD0DA]">
        ...
        <div className="flex gap-4 lg:hidde z-10">{links}</div>
      </div>
    </section>
  );
};
