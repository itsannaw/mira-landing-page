      ...
      <div>
        <div className="flex justify-between">
          <Card type={HOW_IT_WORKS_CARDS.PLUS}>
            Вы фиксируете эмоции и мысли, которые с ними связаны, в любое
            удобное для вас время. «Мира» запоминает эти данные и бережно хранит
            их на вашем устройстве.
          </Card>
          <Card type={HOW_IT_WORKS_CARDS.CHART}>
            На основе сделанных записей Мира формирует статистику, которая
            поможет посмотреть на жизненную ситуацию со стороны: обратить
            внимание на аспекты, которые вызывают больше всего позитивных или,
            напротив, отрицтельных эмоций.
          </Card>
          <Card type={HOW_IT_WORKS_CARDS.PRAXIS}>
            Мира подбирает психотерапевтическую технику, опираясь на ваше
            состояние. Упражнения внимательно отобраны специалистом, проходятся
            за короткое время и имеют доказанную эффективность.
          </Card>
        </div>
        <div></div>
      </div>
