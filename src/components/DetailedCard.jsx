...
const CARDS_MAPPER = {
  [HOW_IT_WORKS_CARDS.PLUS]: {
    ...
    size_phone:
      "max-lg:md:max-w-[360px] xl:w-[457px] xl:h-[523px] md:w-[360px] md:h-[330px] w-[290px] h-[260px] left-[70px] xl:left-[110px] top-[40px]",
  ...
  [HOW_IT_WORKS_CARDS.CHART]: {
    ...
    size_phone:
      "max-lg:md:max-w-[360px] w-[290px] h-[260px] md:w-[360px] md:h-[330px] xl:w-[500px] xl:h-[585px] left-[69px]",
  ...
  [HOW_IT_WORKS_CARDS.PRAXIS]: {
    ...
    text_color: "text-white",
    size_phone:
      "max-lg:md:max-w-[360px] w-[300px] h-[270px] left-[40px] md:w-[360px] md:h-[330px] xl:w-[565px] xl:h-[595px] left-[9px] bottom-[-5px] ",
...
const DetailedCard = (props) => {
  ...
  return (
    <div className="card" id={card.id}>
      <div
        className={`relative overflow-hidden w-full xl:h-[625px] sm:h-[590px] md:h-[440px] lg:h-[440px] p-[20px] md:pt-10  ${card.bg_color} rounded-[20px] z-10 duration-500`}
      >
        <img
        ...
        >
          <div className="flex flex-col w-full max-w-[480px] gap-5">
            ...
            <span className="text-[14px] md:text-base xl:text-[28px] leading-[18px] xl:leading-[38px] tracking-[0.1px] xl:tracking-[0.7px] font-medium xl:font-normal">
              {card.text3}
            </span>
